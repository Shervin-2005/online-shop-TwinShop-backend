...
namespace TwinShop.Shared.DTOS
{
    public class MessagesAndConsts
    {
        ...
        public const string ErrorGetingCategories = "خطا در دریافت کتگوری‌ها";
        public const string ErrorGetingBrands = "خطا در دریافت برند ها";
        ...
        public const string ProductNameAlreadyExist = "Product name is alredy exist";
